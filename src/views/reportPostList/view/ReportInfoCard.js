    ...
    if (
      ...
      return (
        <Avatar
          ...
          content={selectedReport[0]?._id?.postData?.description} 
          contentStyles={{
            borderRadius: 0,
            fontSize: "calc(48px)",
            width: "100%",
          ...
          <div className="info-container">
            {selectedReport[0] !== null ? (
              <ul className="list-unstyled">
                <li className="mb-75">
                  <span className="fw-bolder me-25">{<Title str='Postuploadby' />} : </span>
                  <span>{selectedReport[0]?._id?.postData?.userId?.firstName} {selectedReport[0]?._id?.postData?.userId?.lastName}</span>
                </li>
                <li className="mb-75">
                  <span className="fw-bolder me-25">{<Title str='ReportCount' />} : </span>
                  <span>{selectedReport[0]?.popstCount}</span>
                </li>
                <li className="mb-75">
                  <span className="fw-bolder me-25">{<Title str='Description' />} : </span>
                  <span>{selectedReport[0]?._id?.postData?.description}</span>
                </li>

                <li className="mb-75">
                  <span className="fw-bolder me-25">{<Title str='Email' />} : </span>
                  <span>{selectedReport[0]?._id?.postData?.userId?.email}</span>
                </li>
