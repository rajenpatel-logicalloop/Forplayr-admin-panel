...
const ReportInfoCard = ({ selectedReport }) => {
  ...
  const renderReportImg = () => {
    if (
      selectedReport !== null &&
      `${S3BUCKET}${selectedReport[0]?._id?.editorialData?.coverPage}` !==
        null
    ) {
      return (
        <img
          ...
          width="110"
          alt="report-avatar"
          src={`${S3BUCKET}${selectedReport[0]?._id?.editorialData?.coverPage}`}
          className="img-fluid rounded mt-3 mb-2"
        />
      );
    } else if (
      selectedReport !== null &&
      `${S3BUCKET}${selectedReport[0]?._id?.editorialData?.logo}` !==
        null
    ) {
      return (
        <img
          ...
          width="110"
          alt="report-avatar"
          src={`${S3BUCKET}${selectedReport[0]?._id?.editorialData?.logo}`}
          className="img-fluid rounded mt-3 mb-2"
        />
      );
    } else {
